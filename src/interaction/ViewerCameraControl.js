...
/**
 * @desc A custom camera control for this viewer.
 */
class ViewerCameraControl extends Component {

    /**
     * @private
     */
    get type() {
        return "ViewerCameraControl";
    }
    ...
    /**
     *  Sets if this ViewerCameraControl is active or not.
     *
     * Default value is ````true````.
     *
     * @param {Boolean} value Set ````true```` to activate this ViewerCameraControl.
     */
    set active(value) {
    ...
    /**
     * Gets if this ViewerCameraControl is active or not.
     *
     * Default value is ````true````.
     *
     * @returns {Boolean} Returns ````true```` if this ViewerCameraControl is active.
     */
    get active() {
        return this._active;
    }
     ...
     *
     * The pivot point is indicated by {@link ViewerCameraControl#pivotPos}.
     *
     * When in pivoting mode, clicking on an {@link Entity} will set {@link ViewerCameraControl#pivotPos} to the clicked position on the surface of the Entity.
     *
    ...
    /**
     * Sets whether this ViewerCameraControl is in plan-view mode.
     *
    ...
    /**
     * Gets whether this ViewerCameraControl is in plan-view mode.
     *
     * When in plan-view mode, rotation is disabled.
     *
     * Default value is ````false````.
    ...
    /**
     * Sets whether this ViewerCameraControl is in first-person mode.
     *
    ...
    /**
     * Gets whether this ViewerCameraControl is in first-person mode.
     *
     * In "first person" mode (disabled by default) the look position rotates about the eye position. Otherwise,  {@link Camera#eye} rotates about {@link Camera#look}.
     *
     * Default value is ````false````.
    ...
    /**
     * Sets whether this ViewerCameraControl is in walking mode.
     *
     ...
     *
     * This only has an effect when {@link ViewerCameraControl#firstPerson} is ````true````.
     *
     * Default value is ````false````.
     *
    ...
    /**
     * Gets whether this ViewerCameraControl is in walking mode.
     *
     * When set ````true````, this constrains {@link Camera#eye} movement to the horizontal X-Z plane. When doing a walkthrough,
     * this is useful to allow us to look upwards or downwards as we move, while keeping us moving in the  horizontal plane.
     *
        ...
        (function () {
            ...
            (function () {
                ...
                scene.on("tick", function () {
                    ...
                    const panning = shiftDown || mouseDownMiddle;

                    if (panning) {

                        // Panning
                        if (shiftDown || (self.panRightClick && mouseDownMiddle)) {
